...
users = [
   ...
   {email: 'bella@dogchow.com', password: 'pass123', name: 'Bella Marusiak', location_lat: 51.536772, location_lon: -0.062896, bio: 'Not a fussy eater but will do many tricks for a tasty treat'},
