...
users = [
   ...
   {email: 'bella@dogchow.com', password: 'pass123', name: 'Bella Marusiak', location_lat: 51.536676, location_lon: -0.062846, bio: 'Not a fussy eater but will do many tricks for a tasty treat'},
   ...
   {email: 'amylu@princessoftheworld.com', password: 'pass123', name: 'Amy Lu', location_lat: 51.577414, location_lon: -0.017168, bio: 'Obsessed with cheese, pretends to be t-rex, and likes to ride guinea pigs dressed like Hello Kitty.'}
]
